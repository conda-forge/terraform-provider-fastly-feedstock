...
validate_recipe_outputs "terraform-provider-fastly-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-fastly-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi